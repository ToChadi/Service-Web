...
public class ProductServiceSoapBindingStub extends org.apache.axis.client.Stub implements fr.insa.service.ProductService {
    ...
    private static void _initOperationDesc1(){
        ...
        oper.setReturnType(new javax.xml.namespace.QName("http://service.insa.fr/", "product"));
        oper.setReturnClass(fr.insa.service.Product.class);
        ...
        oper = new org.apache.axis.description.OperationDesc();
        oper.setName("searchProductsByCriteria");
    ...
    public ProductServiceSoapBindingStub(javax.xml.rpc.Service service) throws org.apache.axis.AxisFault {
        ...
        ((org.apache.axis.client.Service)super.service).setTypeMappingVersion("1.2");
            ...
            qName = new javax.xml.namespace.QName("http://service.insa.fr/", "product");
            cachedSerQNames.add(qName);
            cls = fr.insa.service.Product.class;
    ...
    public fr.insa.service.Product getProduct(java.lang.String productId) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
        ...
        _call.setOperationName(new javax.xml.namespace.QName("http://service.insa.fr/", "getProduct"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {productId});
        ...
        if (_resp instanceof java.rmi.RemoteException) {
            ...
            try {
                return (fr.insa.service.Product) _resp;
            } catch (java.lang.Exception _exception) {
                return (fr.insa.service.Product) org.apache.axis.utils.JavaUtils.convert(_resp, fr.insa.service.Product.class);
            }
        }
  ...
  throw axisFaultException;
    ...
    public fr.insa.service.Product[] getAllProducts() throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://service.insa.fr/", "getAllProducts"));
 ...
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {});
  ...
  throw axisFaultException;
    ...
    public fr.insa.service.Product[] searchProductsByCriteria(java.lang.String productName, java.lang.String category) throws java.rmi.RemoteException {
        if (super.cachedEndpoint == null) {
            throw new org.apache.axis.NoEndPointException();
        }
        org.apache.axis.client.Call _call = createCall();
        ...
        _call.setProperty(org.apache.axis.AxisEngine.PROP_DOMULTIREFS, Boolean.FALSE);
        _call.setSOAPVersion(org.apache.axis.soap.SOAPConstants.SOAP11_CONSTANTS);
        _call.setOperationName(new javax.xml.namespace.QName("http://service.insa.fr/", "searchProductsByCriteria"));

        setRequestHeaders(_call);
        setAttachments(_call);
 try {        java.lang.Object _resp = _call.invoke(new java.lang.Object[] {productName, category});
